...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registration.picture'
        db.add_column(u'website_registration', 'picture',
                      self.gf('django.db.models.fields.files.FileField')(default='default_face.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Registration.picture'
        db.delete_column(u'website_registration', 'picture')
